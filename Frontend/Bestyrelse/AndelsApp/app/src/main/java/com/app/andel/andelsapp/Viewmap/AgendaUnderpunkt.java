...
public class AgendaUnderpunkt extends AppCompatActivity {
       ...
       // String pointIdTitle= getIntent().getStringExtra("Point Title");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AgendaUnderpunkt.this, MainActivity.class));
            }
        });
        ...
        MyApolloClient.getMyapolloClient().query(
            ...
            public void onResponse(@Nonnull Response<GetSubPointsByPointsIdQuery.Data> response) {
               ...
               // Log.d(TAG1,"OnResponse" + response.data());
                ...
                AgendaUnderpunkt.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
